package com.example.sabriatialidiet.db;
...
public class DataBase {
    private static final String DB_NAME = "SabiAtiAliDB";
    ...
    private static final String sampleExercisesNames[] = {"Basketball", "Volleyball", "Jumping", "Running", "Swimming", "Squats"};
    private static final int sampleExercisesTimeCoeff[] = {1, 1, 3, 0, 4, 6};
    private static final int sampleExercisesQuantityCoeff[] = {12, 7, 4, 0, 0, 6};
    private static final String sampleDishesNames[] = {"Rice", "Pizza", "Hamburger", "Hot dog", "Tea", "Coffee", "Orange", "Apple"};
    private static final int sampleDishesCalories[] = {110, 248, 190, 44, 785, 14, 556, 232};
...
//        }
    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("create table " + DISH_TABLE + " ( " + COLUMN_ID + " integer, " + DISH_COLUMN_NAME + " text primary key," + DISH_COLUMN_CALORIES_PER_100_GM + " integer not null" + ");");
